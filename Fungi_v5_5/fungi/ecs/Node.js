...
class Node{
	// #region FIELDS
	updated			= true;
	local			= new Transform();	// Local space transform data
	world			= new Transform();	// World space transform data, calculated by NodeSystem Update based on Transform Hierachy
