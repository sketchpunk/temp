...
function hermite1D( t, a, b, c, d, tension, bias ){
...
class Hermite{
    ...
    static at( t, a, b, c, d, tension, bias, out ){
        let t2	= t * t,
            t3	= t2 * t,
            a0	= 2*t3 - 3*t2 + 1,
            a1	= t3 - 2*t2 + t,
        ...
        let ten_bias_n	= ( 1 - bias ) * ( 1 - tension ) * 0.5;
        let ten_bias_p	= ( 1 + bias ) * ( 1 - tension ) * 0.5;
    ...
    static dxdy( t, a, b, c, d, tension, bias, out ){
        let tt  = t * t,
            tt6 = 6 * tt,
            tt3 = 3 * tt,
            a0  = tt6 - 6*t,
	...
	static debug( draw, a, b, c, d, tension=0, bias=0, steps=10, inc_dxdy=false ){
        let prev = new Vec3();
        let pos  = new Vec3();
        let dev  = new Vec3();
        let t;
        ...
        // Draw First Point
        this.at( 0, a, b, c, d, tension, bias, prev );
        ...
        for( let i=1; i <= steps; i++ ){
            ...
            //------------------------------------
            // Draw Step
            this.at( t, a, b, c, d, tension, bias, pos );
            draw
                .ln( prev, pos, "yellow" )
            ...
            if( inc_dxdy ){
                this.dxdy( t, a, b, c, d, tension, bias, dev );
