...
class BezierCubic{
	...
	static debug( draw, a, b, c, d, steps=10, inc_dxdy=false, inc_dxdy2=false ){
        let prev = new Vec3();
        let pos  = new Vec3();
        let dev  = new Vec3();
        let t;
